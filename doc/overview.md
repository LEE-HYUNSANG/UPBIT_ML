...
These imported positions do not carry a valid strategy code. The signal loop
therefore evaluates all sell formulas for them, ignoring the placeholder code
`"imported"`.
